...
/**
 * An acceptance test for WrathOfPele versus Crazy.
 * 
 ...
 */
public class TestWrathOfPeleVersusCrazy extends RobotTestBed {
  /**
  ...
  /**
   * The actual test, which asserts that WrathOfPele has won 70% of rounds against Crazy.
   * 
